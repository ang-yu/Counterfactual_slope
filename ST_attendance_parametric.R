...
summary(lm(log_odds1 ~ G, data=detail))$r.squared  # 0.030
summary(lm(log_odds1_desc ~ G, data=detail))$r.squared  # 0.034
summary(lm(log_odds0 ~ G, data=detail))$r.squared  # 0.080
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_attendance",".jpg", sep=""), plot_linear, width=6, height=3.5)
