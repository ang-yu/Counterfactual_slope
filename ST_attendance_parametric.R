...
data <- readRDS("/Users/Ang/Desktop/Research/Counterfactual covariances/Data/data_cleaned_mare_attendance.rds")
colMeans(is.na(data))

data$completion29 <- as.numeric(data$completion29)-1
data$attendance23 <- as.numeric(data$attendance23)-1

#table(data$attendance23[data$parental_income_log<log(5000)])   # very low parental income is associated with very low probability (4.5%) of college completion29
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual covariances/ST_attendance",".jpg", sep=""), plot_linear, width=6, height=3.5)
