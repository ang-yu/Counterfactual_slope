...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_HS_smooth_linear",".jpg", sep=""), plot_smooth, width=6, height=3.5)
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_HS_linear",".jpg", sep=""), plot_linear, width=6, height=3.5)
