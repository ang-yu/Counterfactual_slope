...
summary(lm(IPO_D1_desc ~ G, data=detail))$r.squared  # 0.040
summary(lm(D ~ G, data=detail))$r.squared  # 0.087
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_HS_smooth_linear_parametric",".jpg", sep=""), plot_smooth, width=6, height=3.5)
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_HS_linear_parametric",".jpg", sep=""), plot_linear, width=6, height=3.5)
