...
summary(lm(IPO_D1 ~ G, data=detail))$r.squared  # 0.0003
summary(lm(IPO_D1_desc ~ G, data=detail))$r.squared  # 0.0001
summary(lm(D ~ G, data=detail))$r.squared  # 0.0930
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_completion_smooth_linear_parametric",".jpg", sep=""), plot_smooth, width=6, height=3.5)
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_completion_linear_parametric",".jpg", sep=""), plot_linear, width=6, height=3.5)
