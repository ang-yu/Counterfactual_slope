...
data <- readRDS("/Users/Ang/Desktop/Research/Counterfactual covariances/Data/data_cleaned_mare_gradaute.rds")
colMeans(is.na(data))
...
# save(detail, file="/Users/Ang/Desktop/Research/Counterfactual covariances/ST_completion29_parametric_detail.RData")
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual covariances/ST_completion",".jpg", sep=""), plot_linear, width=6, height=3.5)
