...
data <- readRDS("/Users/Ang/Desktop/Research/Counterfactual slopes/Data/data_cleaned_mare_attendance_conditional.rds")
colMeans(is.na(data))
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_attendance_smooth_conditional_parametric",".jpg", sep=""), plot_smooth, width=6, height=3.5)
...
ggsave(paste("/Users/Ang/Desktop/Research/Counterfactual slopes/ST_attendance_conditional_parametric",".jpg", sep=""), plot_linear, width=6, height=3.5)
